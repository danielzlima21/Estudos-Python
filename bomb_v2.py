#modo por votacao onde os jogadores devem votar em qulal modo de jgogo querem jogar se der empate o modo de jogo e escolhido aleatoriamente
# jogo da velha, palavras embaralhadas, pedra papel e tesoura, 
...
def adivinhar_palavra():#uma palavra de um tema aleatorio e escolhida, tera modo com tentativas e ate acertar se o joagador acertar uma a
    #a vez dele e repetida
    pass
